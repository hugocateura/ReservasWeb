 ...
 <% if (((Persona)session.getAttribute("user")).getCategoria().equals("Online")){%>
	...
	<%} %>
            ...
            <div class="col-10 contenido">
                <h1 class="textoBienvenida">Reserva realizada exitosamente de <%=((Reserva)session.getAttribute("reserva")).getElemento().getNombre()%></h1>
                <h1 class="textoBienvenida">desde <%=((Reserva)session.getAttribute("reserva")).getFechaHoraDesde()%> hasta <%=((Reserva)session.getAttribute("reserva")).getFechaHoraHasta()%></h1>
            </div>
        </div>
