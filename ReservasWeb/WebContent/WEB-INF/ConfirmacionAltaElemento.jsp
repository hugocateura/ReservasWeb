	...
	<%} %>
            ...
            <div class="col-10 contenedor">
            	<div class=" col-8 alert alert-success confirmacion">
            			Alta realizada exitosamente de <%=((Elemento)session.getAttribute("nuevoElemento")).getNombre()%>
 						perteneciente al tipo <%=((Elemento)session.getAttribute("nuevoElemento")).getTipo().getNombre()%>           	
            	</div>
            </div>
             </div>
        </div>
