 ...
 <% if (((Persona)session.getAttribute("user")).getCategoria().equals("Online")){%>
	...
	<%} %>
            ...
            <div class="col-10 contenido">
                <h1 class="textoBienvenida">Alta realizada exitosamente de <%=((Elemento)session.getAttribute("nuevoElemento")).getNombre()%></h1>
                <h1 class="textoBienvenida">perteneciente al tipo <%=((Elemento)session.getAttribute("nuevoElemento")).getTipo().getNombre()%></h1>
            </div>
        </div>
