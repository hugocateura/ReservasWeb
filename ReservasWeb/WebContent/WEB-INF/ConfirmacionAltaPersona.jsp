 ...
 <% if (((Persona)session.getAttribute("user")).getCategoria().equals("Online")){%>
	...
	<%} %>
            ...
            <div class="col-10 contenido">
                <h1 class="textoBienvenida">Alta realizada exitosamente de <%=((Persona)session.getAttribute("nuevoUsuario")).getNombre()%>, <%=((Persona)session.getAttribute("nuevoUsuario")).getApellido()%></h1>
                <h1 class="textoBienvenida">con usuario <%=((Persona)session.getAttribute("nuevoUsuario")).getUsuario()%></h1>
            </div>
        </div>
