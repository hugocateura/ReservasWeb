...
<head>
    ...
    <script>
    	function completarInput() {
    		...
    		var reservaEncargado= "<%=((TipoElemento)session.getAttribute("tipoEleaModificar")).getReservaEncargado()%>";
    					
    		if (reservaEncargado=="true"){
    			document.getElementById("reservaEncargado").checked = true;		    		
    		};
    	}
    </script>
</head>
<body onload="completarInput();">
	...
	<%} %>
            ...
            <div class="col-10 contenido">
	            <form class="formulario" action="ConfirmarModificacionTipoElemento" method="post">
		           	<div class="tituloFormulario" >
		           		<h3>Modificar datos del Tipo de Elemento</h3>
		           	</div>	
		           	
		           	<div class="form-group row">
					    <label class="col-2 col-form-label">Nombre</label>
					    <div class="col-10">
					    	<input type="text" class="form-control" name="tipoElementoNombre" aria-describedby="nombreHelp" placeholder="Ingrese Nombre" value="<%=((TipoElemento)session.getAttribute("tipoEleaModificar")).getNombre()%>" required>
					...
					<div class="form-group row">
					  ...
					  <div class="col-10">
					    <input class="form-control" type="number" name="tipoElementoCantMaxRes" id="example-number-input" aria-describedby="cantmaxHelp" placeholder="Ingrese la cantidad" value="<%=((TipoElemento)session.getAttribute("tipoEleaModificar")).getCant_max_reservas()%>" required>
					...
					<div class="form-group row">
					  ...
					  <div class="col-10">
					    <input class="form-control" type="number" name="tipoElementoCantMaxHs" id="example-number-input" aria-describedby="cantmaxhsHelp" placeholder="Ingrese la duración" value="<%=((TipoElemento)session.getAttribute("tipoEleaModificar")).getLimiteMaxHorasReserva()%>" required>
					...
					<div class="form-group row">
					  ...
					  <div class="col-10">
					    <input class="form-control" type="number" name="anticipacionMaxima" id="example-number-input" aria-describedby="anticipacionMaximaHelp" placeholder="Ingrese la cantidad" value="<%=((TipoElemento)session.getAttribute("tipoEleaModificar")).getCantMaxDiasAnticipacion()%>" required>
				  	...
				  	<div class="form-group row">
				    	...
				    	<div class="col-10">
				    		<input type="checkbox" class="form-check-input" value="1"  id="reservaEncargado" name="reservaEncargado" aria-describedby="reservaEncargadoHelp">
